...
<img width="150" src="gnaud221.github.com/image/제목 없음.png">

그다음 embed를 활용해서 예쁘게 꾸몄다 
<img width="150" src="gnaud221.github.com/image/embed정리.png">
<h2> 영상 선택하기 </h2> 
영상여러개중에 원하는 영상의 번호를 보내면 영상의 자세한 정보가 나오게 했다

정보를 embed를 사용해서 예쁘게 꾸몄다
<img width="150" src="gnaud221.github.com/image/embed 선탣ㄱ.png">
